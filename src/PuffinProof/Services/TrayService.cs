...
public sealed class TrayService : IDisposable
{
    ...
    public TrayService(SettingsStore settings)
    {
        ...
        menu.Items.Add(new Forms.ToolStripSeparator());
        menu.Items.Add("Quit PuffinProof", null, (_, _) => ExitRequested?.Invoke());
    ...
    public void Refresh()
    {
        ...
        _icon.Text = on ? "PuffinProof — on" : "PuffinProof — paused";
    }
    ...
    private static Drawing.Icon LoadIcon()
    {
        ...
        var path = Path.Combine(AppContext.BaseDirectory, "Assets", "puffinproof.ico");
        if (File.Exists(path))
        {
