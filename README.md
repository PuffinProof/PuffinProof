...
PuffinProof is an open-source, local-only alternative to Grammarly that does **one job**: catch spelling mistakes as you type, in any application.
...
- PuffinProof application code: [GNU GPLv3](LICENSE) — free and open source. You may use, change, and share it. You may not ship a closed fork.
- The name **PuffinProof**, the puffin mascot, and the logos are **not** licensed. See [TRADEMARKS.md](TRADEMARKS.md). That is an extra term under GPLv3 section 7(e).
- Official builds are free and come only from this project’s GitHub Releases.
